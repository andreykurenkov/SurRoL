...
buffer = d3rlpy.online.buffers.ReplayBuffer(maxlen=100000, env=wrapped_env)

# start data collection
oracle_policy.collect(wrapped_env, buffer, n_steps=1000000)
